              ...
              <details className="text-[12px]" style={{ color: "var(--ink-3)" }}>
                ...
                <div className="mt-3 p-4 rounded-xl space-y-2" style={{ background: "var(--bg, #000)", border: "1px solid var(--line)" }}>
                  <div className="flex justify-between text-[11px]">
                    ...
                    <span style={{ color: "var(--ink-2)" }}>{process.env.NEXT_PUBLIC_BANK_NAME || "[Set NEXT_PUBLIC_BANK_NAME in .env]"}</span>
                  </div>
                  <div className="flex justify-between text-[11px]">
                    <span style={{ color: "var(--ink-4)" }}>Account</span>
                    <code className="text-[11px]" style={{ color: "var(--ink-2)" }}>{process.env.NEXT_PUBLIC_BANK_ACCOUNT_NUMBER || "[Set NEXT_PUBLIC_BANK_ACCOUNT_NUMBER in .env]"}</code>
                  </div>
                  <div className="flex justify-between text-[11px]">
                    <span style={{ color: "var(--ink-4)" }}>Routing (ACH)</span>
                    <code className="text-[11px]" style={{ color: "var(--ink-2)" }}>{process.env.NEXT_PUBLIC_BANK_ROUTING_NUMBER || "[Set NEXT_PUBLIC_BANK_ROUTING_NUMBER in .env]"}</code>
                  </div>
                  <div className="flex justify-between text-[11px]">
