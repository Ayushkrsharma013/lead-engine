      ...
      <PageTransition className="max-w-3xl space-y-4">
          ...
          {showForm && (
            ...
            >
              <motion.div
                ...
                style={{ background: "var(--surface-elev)", border: "1px solid var(--line)" }}
              >
        ...
        <AnimatePresence mode="wait">
          {sequences.length === 0 ? (
            ...
            >
              <Layers size={40} style={{ color: "var(--ink-4)", margin: "0 auto 16px", opacity: 0.4 }} />
              ...
              {sequences.map((seq, i) => (
                <motion.div
                  ...
                  style={{
                    ...
                    border: seq.status === "active" ? "1px solid rgba(34,197,94,0.2)" : "1px solid var(--line)",
                  }}
                >
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg flex items-center justify-center"
                      style={{ background: "rgba(232,74,10,0.08)", border: "1px solid rgba(232,74,10,0.15)" }}>
