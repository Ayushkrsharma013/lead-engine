    ...
    <div className="flex-1 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md rounded-3xl p-8 glass-card">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          />
          <h1 className="text-[22px] font-bold tracking-[-0.02em]" style={{ color: "var(--ink)" }}>
            Client Portal
          </h1>
          <p className="text-[13px] mt-1.5" style={{ color: "var(--ink-3)" }}>
            Sign in to your Prospecting OS dashboard
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label
              className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.12em] mb-2"
          ...
          {error && (
            <p className="text-[12px] font-medium" style={{ color: "var(--negative)" }}>
              {error}
            </p>
          )}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(232,168,64,0.04) 0%, transparent 70%)",
        }}
      />
